...
namespace Store
{
    public partial class Posts : Form
    {
        ...
        {
            var queryString = "Select *, 'Удалить' as Command from posts";
        ...
        {
            (dataGridView1.DataSource as DataTable).DefaultView.RowFilter = string.Format("CONVERT(post_code, System.String) LIKE '%{0}%' OR post_title LIKE '%{0}%'", tbSearch.Text);
        }
